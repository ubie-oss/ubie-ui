import{j as t}from"./jsx-runtime-DuyR_K1q.js";import{A as J,I as R,H as a}from"./Icon-BwCTW7F4.js";import{c as O}from"./clsx-B-dksMZM.js";import{r as f}from"./index-yUhCOHB4.js";import{S as m}from"./Stack-cHauGT6n.js";import"./ArrowBDownIcon-DhMIqqai.js";import"./UnfoldMoreIcon-BpmwIn3S.js";import"./style-BhPSv9pv.js";const U="_card_1ib2g_1",X="_icon_1ib2g_21",G="_text_1ib2g_32",K="_title_1ib2g_39",M="_description_1ib2g_46",Q="_caret_1ib2g_53",Y="_medium_1ib2g_60",Z="_small_1ib2g_67",r={card:U,icon:X,text:G,title:K,description:M,caret:Q,medium:Y,small:Z},$=e=>f.isValidElement(e),ee=e=>{if(e==null)return null;if(typeof e=="string")return t.jsx(R,{icon:e});if($(e))return e;const p=e;return t.jsx(p,{})},s=f.forwardRef(({title:e,size:p="medium",className:W,icon:g,description:h,render:C,...T},w)=>{const P=O(r[p],r.card,W);return((x,_)=>C?f.cloneElement(C,x,_):t.jsx("a",{...x,children:_}))({className:P,...T,ref:w},t.jsxs(t.Fragment,{children:[g!=null&&t.jsx("span",{className:r.icon,children:ee(g)}),t.jsxs("div",{className:r.text,children:[t.jsx("p",{className:r.title,children:e}),h&&t.jsx("p",{className:r.description,children:h})]}),t.jsx(J,{className:r.caret})]}))});s.displayName="LinkCard";try{s.displayName="LinkCard",s.__docgenInfo={description:"",displayName:"LinkCard",props:{href:{defaultValue:null,description:"遷移先URL",name:"href",required:!1,type:{name:"string"}},size:{defaultValue:{value:"medium"},description:"サイズ",name:"size",required:!1,type:{name:"enum",value:[{value:'"medium"'},{value:'"small"'}]}},title:{defaultValue:null,description:"見出しのテキスト",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"説明のテキスト",name:"description",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSSのクラス
*
