import{j as t}from"./jsx-runtime-BJwPuJt0.js";import{A as J,I as q,H as a}from"./Icon-BS3BzWco.js";import{c as O}from"./clsx-B-dksMZM.js";import{r as f}from"./index-DX35FyXq.js";import{S as m}from"./Stack-8w4SRVxc.js";import"./ArrowBDownIcon-DHfX99Bt.js";import"./UbieIcon-Dt0Travo.js";import"./UnfoldMoreIcon-N-Pb1J02.js";import"./style-D1Pgu1yr.js";const U="_card_1nkwn_1",X="_icon_1nkwn_21",G="_text_1nkwn_32",K="_title_1nkwn_39",M="_description_1nkwn_46",Q="_caret_1nkwn_53",Y="_medium_1nkwn_60",Z="_small_1nkwn_67",r={card:U,icon:X,text:G,title:K,description:M,caret:Q,medium:Y,small:Z},$=e=>f.isValidElement(e),ee=e=>{if(e==null)return null;if(typeof e=="string")return t.jsx(q,{icon:e});if($(e))return e;const p=e;return t.jsx(p,{})},s=f.forwardRef(({title:e,size:p="medium",className:R,icon:h,description:g,render:C,...W},T)=>{const P=O(r[p],r.card,R);return((x,_)=>C?f.cloneElement(C,x,_):t.jsx("a",{...x,children:_}))({className:P,...W,ref:T},t.jsxs(t.Fragment,{children:[h!=null&&t.jsx("span",{className:r.icon,children:ee(h)}),t.jsxs("div",{className:r.text,children:[t.jsx("p",{className:r.title,children:e}),g&&t.jsx("p",{className:r.description,children:g})]}),t.jsx(J,{className:r.caret})]}))});s.displayName="LinkCard";try{s.displayName="LinkCard",s.__docgenInfo={description:"",displayName:"LinkCard",props:{href:{defaultValue:null,description:"遷移先URL",name:"href",required:!1,type:{name:"string"}},size:{defaultValue:{value:"medium"},description:"サイズ",name:"size",required:!1,type:{name:"enum",value:[{value:'"medium"'},{value:'"small"'}]}},title:{defaultValue:null,description:"見出しのテキスト",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"説明のテキスト",name:"description",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSSのクラス
*
