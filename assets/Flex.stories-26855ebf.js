import{j as e}from"./jsx-runtime-69eee039.js";import{F as n}from"./Flex-82d33e47.js";import{B as v}from"./Box-7e8eeca7.js";import{c as Ee}from"./clsx-1229b3e0.js";import{r as ye}from"./index-7c191284.js";import{p as fe,m as Ce}from"./style-1d55b7c3.js";const be="_flexItem_1ydru_1",Se="_none_1ydru_8",we="_longhand_1ydru_12",g={flexItem:be,none:Se,longhand:we},a=ye.forwardRef(({children:j,flex:s="none",minWidth:re="auto",maxWidth:ue="none",m:pe,mx:te,my:ie,mt:xe,mr:de,mb:me,ml:ce,p:oe,px:he,py:Ie,pt:ve,pr:ge,pb:je,pl:Fe,...Ae},Be)=>{const De=typeof s=="object"?{"--flex-grow":s.grow!=null?s.grow.toString():"0","--flex-shrink":s.shrink!=null?s.shrink.toString():"1","--flex-basis":s.basis??"auto"}:{};return e.jsx("div",{className:Ee(g.flexItem,s==="none"&&g.none,typeof s=="object"&&g.longhand),ref:Be,style:{"--min-width":re,"--max-width":ue,...De,...fe({p:oe,px:he,py:Ie,pt:ve,pr:ge,pb:je,pl:Fe}),...Ce({m:pe,mx:te,my:ie,mt:xe,mr:de,mb:me,ml:ce})},...Ae,children:j})});a.displayName="FlexItem";try{a.displayName="FlexItem",a.__docgenInfo={description:"FlexやStackの子として配置し、レイアウトを調整",displayName:"FlexItem",props:{flex:{defaultValue:{value:"none"},description:`flexの値を指定。 growなどを指定したい場合はオブジェクトで指定
