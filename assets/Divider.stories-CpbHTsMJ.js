import{j as a}from"./jsx-runtime-BJwPuJt0.js";import{c as W}from"./clsx-B-dksMZM.js";import{r as w}from"./index-DX35FyXq.js";import{m as T,w as N}from"./style-D1Pgu1yr.js";import{S as M}from"./Stack-g6MWvloX.js";const R="_divider_76e26_1",I="_gray_76e26_10",O="_primary_76e26_14",d={divider:R,gray:I,primary:O},e=w.forwardRef(({border:u="gray",m:B,mx:A,my:C,mt:F,mr:S,mb:_,ml:h,width:V,minWidth:b,maxWidth:q,...k},j)=>a.jsx("hr",{className:W(d.divider,d[u]),style:{...T({m:B,mx:A,my:C,mt:F,mr:S,mb:_,ml:h}),...N({width:V,minWidth:b,maxWidth:q})},ref:j,...k}));e.displayName="Divider";try{e.displayName="Divider",e.__docgenInfo={description:"",displayName:"Divider",props:{border:{defaultValue:{value:"gray"},description:"ボーダーの種類",name:"border",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"gray"'}]}},width:{defaultValue:{value:"auto"},description:"幅を指定",name:"width",required:!1,type:{name:"CSSWitdh"}},minWidth:{defaultValue:{value:"auto"},description:"最小幅",name:"minWidth",required:!1,type:{name:"CSSWitdh"}},maxWidth:{defaultValue:{value:"none"},description:"最大幅",name:"maxWidth",required:!1,type:{name:"CSSMaxWidth"}},m:{defaultValue:null,description:`四方のマージンを一括で設定。Spacing Tokenのキーを指定
