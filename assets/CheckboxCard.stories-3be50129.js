import{j as c}from"./jsx-runtime-69eee039.js";import{r as a}from"./index-7c191284.js";import{C as s,a as d}from"./CheckboxGroup-13b7f16a.js";import{S as z}from"./Stack-3105aa16.js";import"./RequiredLabel-0530a236.js";import"./clsx-1229b3e0.js";import"./Icon-a71a699a.js";import"./ArrowBDownIcon-86826e18.js";import"./TrashIcon-de957c6c.js";import"./ThumbUpOutlineIcon-17e2fa33.js";import"./UbieIcon-105662b4.js";import"./UnfoldMoreIcon-402a05cb.js";import"./style-62efef97.js";import"./Flex-4fbea599.js";const Q={title:"Form/CheckboxCard",component:s},M={},l=["option1","option2","option3"],u={render:()=>{const[n,r]=a.useState([l[0]]),o=a.useCallback(e=>{e.currentTarget.checked?r([...n,e.currentTarget.value]):r(n.filter(t=>t!==e.currentTarget.value))},[n]);return c.jsxs(z,{spacing:"lg",children:[c.jsx(d,{label:"Checkbox",children:l.map(e=>c.jsx(s,{name:"default",value:e,onChange:o,checked:n.includes(e),children:e},e))}),c.jsxs("dl",{children:[c.jsx("dt",{children:"Values"}),c.jsx("dd",{children:n.join(",")})]})]})}},m={render:()=>{const[n,r]=a.useState([l[0]]),o=a.useCallback(e=>{e.currentTarget.checked?r([...n,e.currentTarget.value]):r(n.filter(t=>t!==e.currentTarget.value))},[n]);return c.jsx(d,{label:"Checkbox",children:l.map(e=>c.jsx(s,{disabled:!0,name:"default",value:e,onChange:o,checked:n.includes(e),children:e},e))})}},i={render:()=>{const[n,r]=a.useState([l[0]]),o=a.useCallback(e=>{e.currentTarget.checked?r([...n,e.currentTarget.value]):r(n.filter(t=>t!==e.currentTarget.value))},[n]);return c.jsx(d,{label:"Checkbox",direction:"row",children:l.map(e=>c.jsx(s,{name:"horizontally",value:e,onChange:o,checked:n.includes(e),id:e,children:e},e))})}},p={render:n=>{const[r,o]=a.useState([l[0]]),e=a.useCallback(t=>{t.currentTarget.checked?o([...r,t.currentTarget.value]):o(r.filter(k=>k!==t.currentTarget.value))},[r]);return c.jsx(d,{label:"Checkbox",children:l.map(t=>a.createElement(s,{block:!0,...n,key:t,checked:r.includes(t),value:t,onChange:e,name:"block"},t))})},args:{...M,name:"block",block:!0}},h={render:n=>{const[r,o]=a.useState([l[0]]),e=a.useCallback(t=>{t.currentTarget.checked?o([...r,t.currentTarget.value]):o(r.filter(k=>k!==t.currentTarget.value))},[r]);return c.jsx(d,{children:l.map(t=>a.createElement(s,{block:!0,...n,key:t,checked:r.includes(t),value:t,onChange:e,name:"block"},t))})},args:{...M,name:"block",block:!0}};var C,g,b;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => {
...
}`,...(G=(E=p.parameters)==null?void 0:E.docs)==null?void 0:G.source}}};var H,y,L;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: args => {
    const [selectedItem, setSelectedItem] = useState<string[]>([options[0]]);
    const onChange: ChangeEventHandler<HTMLInputElement> = useCallback(event => {
      if (event.currentTarget.checked) {
...
}`,...(L=(y=h.parameters)==null?void 0:y.docs)==null?void 0:L.source}}};const U=["Default","Disabled","Horizontally","Block","NoLabelOnGroup"];export{p as Block,u as Default,m as Disabled,i as Horizontally,h as NoLabelOnGroup,U as __namedExportsOrder,Q as default};
