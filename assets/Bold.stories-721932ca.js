import{j as e}from"./jsx-runtime-69eee039.js";import{S as f}from"./Stack-ac2b4f0f.js";import{T as C}from"./Text-f8d9bbc4.js";import"./index-7c191284.js";import"./clsx-1229b3e0.js";import"./style-e9a2251f.js";const E="_bold_wghus_1",D={bold:E},r=({as:s="span",children:_,id:b,...y})=>{const A=s;return e.jsx(A,{className:D.bold,id:b,...y,children:_})};try{r.displayName="Bold",r.__docgenInfo={description:"",displayName:"Bold",props:{as:{defaultValue:{value:"span"},description:"レンダリングされる要素",name:"as",required:!1,type:{name:"enum",value:[{value:'"b"'},{value:'"em"'},{value:'"i"'},{value:'"span"'},{value:'"strong"'}]}},id:{defaultValue:null,description:"ネイティブ要素の`id`属性。ページで固有のIDを指定",name:"id",required:!1,type:{name:"string"}}}}}catch{}const W={title:"Typography/font/Bold",component:r},a={render:()=>e.jsxs(f,{spacing:"md",children:[e.jsx(r,{children:"default(span)"}),e.jsx(r,{as:"span",children:"span"}),e.jsx(r,{as:"b",children:"b"}),e.jsx(r,{as:"strong",children:"strong"}),e.jsx(r,{as:"em",children:"em"}),e.jsx(r,{as:"i",children:"i"})]})},n={render:()=>e.jsxs(C,{type:"body",size:"lg",color:"main",children:["一部だけ",e.jsx(r,{children:"太字"}),"にしたい"]})},o={render:s=>e.jsx(r,{...s,children:"太字"}),args:{id:"some-id"}},t={render:s=>e.jsx(r,{...s,children:"太字"}),args:{"data-test-id":"some-id"}};var d,u,l;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => {
