...
@default false`,defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"CSSのクラス"}}};const Z={title:"Form/Select",component:s},p={isInvalid:!1,disabled:!1},i={render:n=>{const t=["option1","option2","option3"],[o,u]=f.useState(t[0]),m=f.useCallback(a=>{u(a.target.value)},[]);return e.jsxs(L,{spacing:"md",alignItems:"normal",children:[e.jsx(s,{...n,value:o,onChange:m,children:t.map(a=>e.jsx("option",{children:a},a))}),e.jsxs("dl",{children:[e.jsx("dt",{children:"Value"}),e.jsx("dd",{children:o})]})]})},args:p},l={render:n=>{const t=["option1","option2","option3"];return e.jsx(s,{...n,value:t[0],children:t.map(o=>e.jsx("option",{children:o},o))})},args:{...p,disabled:!0}},d={render:n=>{const t=["option1","option2","option3"];return e.jsx(s,{...n,value:t[0],children:t.map(o=>e.jsx("option",{children:o},o))})},args:{...p,isInvalid:!0}},c={render:n=>{const t=["option1","option2","option3"];return e.jsx(s,{...n,value:t[0],children:t.map(o=>e.jsx("option",{"data-test-id":n["data-test-id"],children:o},o))})},args:{...p,"data-test-id":"select-custom-data-attribute"}};var g,v,S;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...
  args: defaultArgs
}`,...(S=(v=i.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};var h,x,b;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => {
    const options = ['option1', 'option2', 'option3'];
...
}`,...(b=(x=l.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var I,C,j;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
    const options = ['option1', 'option2', 'option3'];
    return <Select {...args} value={options[0]}>
        {options.map(o => <option key={o}>{o}</option>)}
...
}`,...(j=(C=d.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};var _,w,y;c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
    const options = ['option1', 'option2', 'option3'];
    return <Select {...args} value={options[0]}>
