import{j as e}from"./jsx-runtime-69eee039.js";import{F as n}from"./Flex-4acfbe57.js";import{B as ve}from"./Box-fa60da99.js";import{c as ge}from"./clsx-1229b3e0.js";import{r as he}from"./index-7c191284.js";import{p as je,m as Fe}from"./style-62efef97.js";const Ie="_flexItem_1ydru_1",De="_none_1ydru_8",Ae="_longhand_1ydru_12",v={flexItem:Ie,none:De,longhand:Ae},u=he.forwardRef(({children:g,flex:s="none",minWidth:X="auto",maxWidth:Y="none",m:Z,mx:$,my:ee,mt:ne,mr:se,mb:ue,ml:le,p:ae,px:xe,py:re,pt:ie,pr:de,pb:te,pl:pe,...me},ce)=>{const oe=typeof s=="object"?{"--flex-grow":s.grow!=null?s.grow.toString():"0","--flex-shrink":s.shrink!=null?s.shrink.toString():"1","--flex-basis":s.basis??"auto"}:{};return e.jsx("div",{className:ge(v.flexItem,s==="none"&&v.none,typeof s=="object"&&v.longhand),ref:ce,style:{"--min-width":X,"--max-width":Y,...oe,...je({p:ae,px:xe,py:re,pt:ie,pr:de,pb:te,pl:pe}),...Fe({m:Z,mx:$,my:ee,mt:ne,mr:se,mb:ue,ml:le})},...me,children:g})});u.displayName="FlexItem";try{u.displayName="FlexItem",u.__docgenInfo={description:"FlexやStackの子として配置し、レイアウトを調整",displayName:"FlexItem",props:{flex:{defaultValue:{value:"none"},description:`flexの値を指定。 growなどを指定したい場合はオブジェクトで指定
...
}`,...(A=(D=a.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var f,B,E;x.parameters={...x.parameters,docs:{...(f=x.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => <div style={{
    height: 500
  }}>
...
}`,...(E=(B=x.parameters)==null?void 0:B.docs)==null?void 0:E.source}}};var y,C,S;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => <>
