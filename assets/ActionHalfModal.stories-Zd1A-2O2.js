...
}`,...(ae=(te=E.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var re,ue,se;B.parameters={...B.parameters,docs:{...(re=B.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(true);
    const onClose = useCallback(() => {
      setOpen(false);
...
}`,...(se=(ue=B.parameters)==null?void 0:ue.docs)==null?void 0:se.source}}};const Cn=["Default","Secondary","Fullscreen","NoCloseButton","Customized","WithId","CustomHeader","WithHero","WithHeroAndFullScreen","StickyHeaderAndFooter"];export{g as CustomHeader,h as Customized,y as Default,f as Fullscreen,b as NoCloseButton,A as Secondary,B as StickyHeaderAndFooter,v as WithHero,E as WithHeroAndFullScreen,F as WithId,Cn as __namedExportsOrder,mn as default};
