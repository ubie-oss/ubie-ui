import{j as a}from"./jsx-runtime-BJwPuJt0.js";import{c as W}from"./clsx-B-dksMZM.js";import{r as w}from"./index-DX35FyXq.js";import{m as T,w as M}from"./style-D1Pgu1yr.js";import{S as N}from"./Stack-B5gcNMwP.js";const R="_divider_76e26_1",I="_gray_76e26_10",O="_primary_76e26_14",d={divider:R,gray:I,primary:O},e=w.forwardRef(({border:u="gray",m:B,mx:A,my:C,mt:F,mr:S,mb:_,ml:V,width:h,minWidth:b,maxWidth:q,...k},j)=>a.jsx("hr",{className:W(d.divider,d[u]),style:{...T({m:B,mx:A,my:C,mt:F,mr:S,mb:_,ml:V}),...M({width:h,minWidth:b,maxWidth:q})},ref:j,...k}));e.displayName="Divider";try{e.displayName="Divider",e.__docgenInfo={description:"",displayName:"Divider",props:{border:{defaultValue:{value:"gray"},description:"ボーダーの種類",name:"border",required:!1,type:{name:"enum",value:[{value:'"gray"'},{value:'"primary"'}]}},width:{defaultValue:null,description:`幅を指定
...
xxs=4px, xs=8px, sm=12px, md=16px, lg=24px, xl=40px, xxl=64px`,name:"ml",required:!1,type:{name:"enum",value:[{value:'"xxs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'},{value:'"xxl"'}]}}}}}catch{}const L={component:e},x={border:"gray"},r={render:u=>a.jsx(e,{...u}),args:x},l={render:()=>a.jsxs(N,{spacing:"md",children:[a.jsx(e,{border:"gray"}),a.jsx(e,{border:"primary"})]})},s={render:u=>a.jsx(e,{...u}),args:{...x,mt:"md",mr:"lg",mb:"xl",ml:"xxl"}},n={render:u=>a.jsx(e,{...u}),args:{...x,width:"50%"}};var m,i,t;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(v=(o=l.parameters)==null?void 0:o.docs)==null?void 0:v.source}}};var c,g,f;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => <Divider {...args} />,
  args: {
    ...defaultArgs,
    mt: 'md',
...
}`,...(f=(g=s.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var E,y,D;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => <Divider {...args} />,
  args: {
    ...defaultArgs,
    width: '50%'
  }
}`,...(D=(y=n.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const P=["Default","BorderVariants","Margins","Width"];export{l as BorderVariants,r as Default,s as Margins,n as Width,P as __namedExportsOrder,L as default};
