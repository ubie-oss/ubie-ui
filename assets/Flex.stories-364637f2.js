import{j as e}from"./jsx-runtime-69eee039.js";import{F as n}from"./Flex-367114be.js";import{B as v}from"./Box-e70db646.js";import{c as Ee}from"./clsx-1229b3e0.js";import{r as ye}from"./index-7c191284.js";import{p as fe,m as Ce}from"./style-282c756e.js";const be="_flexItem_1ydru_1",Se="_none_1ydru_8",we="_longhand_1ydru_12",g={flexItem:be,none:Se,longhand:we},a=ye.forwardRef(({children:j,flex:s="none",minWidth:re="auto",maxWidth:ue="none",m:pe,mx:te,my:ie,mt:xe,mr:de,mb:me,ml:ce,p:oe,px:he,py:Ie,pt:ve,pr:ge,pb:je,pl:Fe,...Ae},Be)=>{const De=typeof s=="object"?{"--flex-grow":s.grow!=null?s.grow.toString():"0","--flex-shrink":s.shrink!=null?s.shrink.toString():"1","--flex-basis":s.basis??"auto"}:{};return e.jsx("div",{className:Ee(g.flexItem,s==="none"&&g.none,typeof s=="object"&&g.longhand),ref:Be,style:{"--min-width":re,"--max-width":ue,...De,...fe({p:oe,px:he,py:Ie,pt:ve,pr:ge,pb:je,pl:Fe}),...Ce({m:pe,mx:te,my:ie,mt:xe,mr:de,mb:me,ml:ce})},...Ae,children:j})});a.displayName="FlexItem";try{a.displayName="FlexItem",a.__docgenInfo={description:"FlexやStackの子として配置し、レイアウトを調整",displayName:"FlexItem",props:{flex:{defaultValue:{value:"none"},description:`flexの値を指定。 growなどを指定したい場合はオブジェクトで指定
@defaultValue none`,name:"flex",required:!1,type:{name:'"none" | FlexProperty'}},minWidth:{defaultValue:{value:"auto"},description:`最小幅
@defaultValue auto`,name:"minWidth",required:!1,type:{name:"CSSMinWidth"}},maxWidth:{defaultValue:{value:"none"},description:`最大幅
@defaultValue none`,name:"maxWidth",required:!1,type:{name:"CSSMaxWidth"}},m:{defaultValue:null,description:`四方のマージンを一括で設定。Spacing Tokenのキーを指定
...
}`,...(B=(A=l.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};var D,E,y;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => <div>
...
}`,...(y=(E=r.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};var f,C,b;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => <div style={{
    height: 500
  }}>
...
}`,...(b=(C=u.parameters)==null?void 0:C.docs)==null?void 0:b.source}}};var S,w,k;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <>
...
}`,...(k=(w=p.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var V,_,W;t.parameters={...t.parameters,docs:{...(V=t.parameters)==null?void 0:V.docs,source:{originalSource:`{
